...
{
	public static class KmsourceManager
	{
	
		public static Sprite LoadSpriteFromDisk(string path, int width = 512, int height = 512)
		{
		...
		public static Sprite LoadSpriteFromByteArray(Il2CppStructArray<byte> bytes, int width = 512, int height = 512)
		{
			if (bytes == null || bytes.Length == 0)
			{
				return null;
		...
		public static Sprite LoadSpriteFromBundledResource(string path, int width = 512, int height = 512)
		{
